...
def get_mbr_parser():
    ...
    ### Diverse MBR
    parser.add_argument('--diverse_k', type=int, default=4, help='number of output sequences for diverse MBR')
    # parser.add_argument('--diverse_pen', type=float, default=0.5, help='diversity penalty for diverse MBR')
    parser.add_argument('--diversity_penalty', type=float, default=1.0, help="diversity penalty for sampling algorithm")
    parser.add_argument('--pairwise_eval', type=str, default='sacrebleu', help="diversity evaluation metric")
